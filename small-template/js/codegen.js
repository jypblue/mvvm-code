...
var proto = CodeGen.prototype;

proto.walkRoot = function(astRoot) {
  this.walk(astRoot,' ', '0');
}

proto.walk = function(node, indent, parentIndex) {
...
proto.genStat = function(node, indent, parentIndex) {
  var self = this;
...
// 条件if-else
proto.genIfStat = function(node, indent, parentIndex) {
...
proto.genElseIf = function(node, indent, parentIndex) {
...
proto.genEachStat = function(node, indent, parentIndex) {
...
proto.genNode = function(node, indent, parentIndex) {
  ...
  this.lines.push(
    ...
    '", '+ proto.getAttrs(node) + ', ' + nodeName + '.children);'
  )
...
proto.genString = function(node, indent, parentIndex) {
